...
class Trainer(object):
    ...
    def test(self, name):
        ...
        for i in range(self.steps):
            ...
            for sampling in self.sampling_methods:
                trans_x_train, trains_y_train = sampling(x_train_scaled, y_train)

                print('******************************', sampling.__name__)

                for clf in self.classifiers:
                    method_name = sampling.__name__ + '_' + clf.__name__
                    y_pred = clf(trans_x_train, trains_y_train, x_test_scaled)
    ...
    def test_all(self):
        ...
        for name in self.dataset_names:
            ...
            total_indicators = self.test(name)
            for algo_name in total_indicators.keys():
                ...
                all_row = [name] + indicator_values.tolist()
                ...
                mean_row = [name] + mean_value.tolist()
